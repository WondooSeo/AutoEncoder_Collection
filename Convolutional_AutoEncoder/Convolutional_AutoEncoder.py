...
def CAE_decoder():
    ...
    decoder.add(Conv2DTranspose(filters=128, kernel_size=3, padding='same'))
    decoder.add(BatchNormalization())
    decoder.add(ReLU())
    decoder.add(UpSampling2D(size=(2, 2), interpolation='nearest'))
    decoder.add(Conv2DTranspose(filters=64, kernel_size=3, padding='same'))
    decoder.add(BatchNormalization())
    decoder.add(ReLU())
    decoder.add(UpSampling2D(size=(2, 2), interpolation='nearest'))
    decoder.add(Conv2DTranspose(filters=32, kernel_size=3, padding='same'))
    decoder.add(BatchNormalization())
    decoder.add(ReLU())
    decoder.add(UpSampling2D(size=(2, 2), interpolation='nearest'))
    decoder.add(Conv2DTranspose(filters=16, kernel_size=3, padding='same'))
    decoder.add(BatchNormalization())
    decoder.add(ReLU())
    decoder.add(UpSampling2D(size=(2, 2), interpolation='nearest'))
